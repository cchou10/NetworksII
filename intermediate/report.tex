...
functions, the static analysis of the bytecode isn't outright difficult. Using 
...
\centering
\caption{}
\includegraphics[scale=0.7]{dist}
\end{figure}
...
OCW's ASM project) and found that the degree distribution looks to be
about power law based on their \g{loglog} plots. Recall that if a distribution has
