...
to $O\left(\sqrt[\alpha]{n}\right)$ for some $\alpha \approx 1.27$.}
...
\begin{figure}
\caption{Log-Log degree distribution for the MARS project.\label{fig:marsold}}
...
linear regression, we essentially remove all of the noise! This is computed by the
 \g{cumulativeDistribution} subroutine within the code in the appendix.

% TODO(Lee) explain why scale-free networks are what's good - already did in section 2
